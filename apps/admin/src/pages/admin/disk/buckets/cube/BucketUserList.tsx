...
import {storeBucketUserApi} from "@/services/disk";
import {ApiEffectLayoutContext} from "@/layout/ApiEffectLayout";
import {AuthDelBtn, FaEnums, FaUtils} from "@fa/ui";
      ...
      <Table
        ...
        columns={[
          ...
          {dataIndex: 'crtTime', title: '创建时间'},
          {
            ...
            render: (_, r) => (
              <Space>
                {r.type !== FaEnums.StoreBucketUserTypeEnum.CREATOR && <AuthDelBtn handleDelete={() => handleDelete(r.id)} />}
              </Space>
            ),
            width: 80,
            fixed: 'right',
